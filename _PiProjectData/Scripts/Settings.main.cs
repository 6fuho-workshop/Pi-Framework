...
public partial class Settings : RuntimeSettings, IPersistentSetting
{
    ...
    [Serializable]
    public class DevSettings : SettingNode, IPersistentSetting
    {
        [SerializeField]
        private bool _logPiMessages = false;
        [SerializeField]
        private bool _testPath2 = false;

        public bool logPiMessages => _logPiMessages;

        public bool testPath2
        {
            get { return _testPath2; }
            set { if(_testPath2 == value) return; _testPath2 = value; OnChanged("testPath2"); dataStore.SetBool("dev.testPath2", value); }
        }

    public void OnLoadCallback()
    {
        testPath2 = dataStore.GetBool("dev.testPath2", _testPath2);
    }
    }
