...
namespace PF.Primitives
{
    ...
    /// </remarks>
    public class PiProgress<T> : IProgress<T>
    {
        ...
        public PiProgress(Action<T> handler) : this()
        {
...
#else
// .NET chuẩn: kế thừa System.Progress<T>
public class PiProgress<T> : Progress<T>
{
    public PiProgress(Action<T> handler) : base(handler) { }
}
#endif
}