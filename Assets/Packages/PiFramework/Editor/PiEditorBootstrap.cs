...
namespace PF.PiEditor
{
    internal class PiEditorBootstrap
    {
        ...
        static void ValidateModulePrefabs()
        {
            ...
            var prefab = PrefabUtility.LoadPrefabContents(PathHelper.PiPrefabPath);
            ...
            if (dirty)
                PrefabUtility.SaveAsPrefabAsset(prefab, PathHelper.PiPrefabPath);
            ...
            {
                var assetPath = PathHelper.ModulesDir + "/" + moduleType.Name + ".prefab";
