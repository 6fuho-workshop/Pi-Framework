...
namespace CsCodeGenerator
{
    public class ClassModel : BaseElement
    {
        ...
        public override string ToString()
        {
            ...
            {
                f.IndentSize = this.IndentSize + CsGenerator.DefaultTabSize;
            }
            ...
            {
                p.IndentSize = this.IndentSize + CsGenerator.DefaultTabSize;
            }
            ...
            {
                c.IndentSize = this.IndentSize + CsGenerator.DefaultTabSize;
            }
