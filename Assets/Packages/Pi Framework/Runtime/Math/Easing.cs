...
namespace PiFramework.MathUtils
{
    ...
    {
        #region fork @Hant
        private delegate float Equation(float t, float b, float c, float d);
        private static Equation[] equations = new Equation[]
        {
            Linear,
            ExpoEaseInOut,
            ExpoEaseOut,
        ...
        /// <summary>
        /// Easing with a Named function (easy change) 
        /// Use direct Easing Functions for better performance!
        /// </summary>
        /// <param name="equation"></param>
        /// <param name="t">Current time.</param>
        /// <param name="b">Starting value.</param>
        /// <param name="c">Final Change.</param>
        /// <param name="d">Duration of animation.</param>
        /// <returns></returns>
        public static float Ease(EasingFunction equation, float t, float b, float c, float d)
        {
            return equations[(int)equation].Invoke(t, b, c, d);
        }
        ...
        /// <param name="b">Starting value.</param>
        /// <param name="c">Change (final value - starting value).</param>
        /// <param name="d">Duration of animation.</param>
