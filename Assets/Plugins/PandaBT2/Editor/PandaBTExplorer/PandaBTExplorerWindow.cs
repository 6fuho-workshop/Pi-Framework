		...
		private void RefreshScope()
		{
			...
			switch (_filter.scope)
			{
				...
				case Scope.Hierarchy:
					...
					var allGameObjects = GameObject.FindObjectsByType<GameObject>( findObjectsInactive: FindObjectsInactive.Include, FindObjectsSortMode.None);
#else
					var allGameObjects = GameObject.FindObjectsOfType<GameObject>(includeInactive: true);
#endif
